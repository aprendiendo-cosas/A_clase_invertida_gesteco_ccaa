#  Instrucciones para la preparación de una clase sobre ámbitos de gestión sectorial de ecosistemas
...
## 1 Objetivos 
La finalidad última de este guión es suministrar unas instrucciones para completar la tarea de preparar e impartir una clase sobre distintos ámbitos de gestión ecosistémica (caza, gestión forestal, etc.)

Desde un punto de vista docente, conseguir esa finalidad implica lograr también los siguientes objetivos de aprendizaje:
+ Mejorar el manejo de las herramientas IA como copilotos del aprendizaje profundo.
+ Adquirir conocimiento sobre un ámbito concreto de gestión de ecosistemas.
+ Mejorar las capacidades de trabajo en equipo.
+ Entrenar la expresión oral de ideas complejas. 
+ Establecer relaciones entre el aprendizaje adquirido por los distintos grupos de la clase.



## 2 Formulación del ejercicio

Cada uno de los grupos tendrá que preparar una clase sobre un ámbito de gestión concreto. Las asignaciones son las siguientes:


+ Gestión de especies amenazadas -> Grupo 3.
+ Manejo de especies invasoras -> Grupo 1
+ Gestión forestal -> Grupo 4
+ Gestión cinegética -> Grupo 2
+ Espacios Naturales Protegidos -> Grupo 5

Esta actividad se encuadra en el bloque de la asignatura que hemos denominado "técnicas o métodos usados actualmente en la gestión de ecosistemas". La idea es que los estudiantes aprendan sobre el ámbito de gestión que se les ha asignado y que resuman los conocimientos adquiridos ante sus compañeros. 

Como la idea es describir las técnicas y métodos que utilizamos para gestionar ciertos componentes o compartimentos de los socioecosistemas, os propongo que todas las clases tengan una estructura similar. Es decir, analizaremos los distintos compartimentos (gestión de especies amenazadas, manejo de invasoras, etc.) bajo el mismo marco conceptual. Esto quiere decir que todas las clases deberán de incidir en los siguientes ejes analíticos:
...
+ Las fuentes de datos que aporte la IA deben de ser descargados y almacenados en una carpeta del OneDrive que comparte cada alumno en su grupo.
...
<iframe width="560" height="515" src="https://www.youtube.com/embed/UAYkcJ8HkW8?si=xxUaA01pVgJPoXiZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
